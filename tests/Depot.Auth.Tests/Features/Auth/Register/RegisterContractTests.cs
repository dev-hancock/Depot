...
// {
//     public static IEnumerable<object[]> EquivalentUsernames => Equivalents(Fixture.Faker.Internet.UserName());
//
//     public static IEnumerable<object[]> EquivalentEmails => Equivalents(Fixture.Faker.Internet.Email());
//
